...
st.set_page_config(page_title="Explorateur API Ratings & Reviews : Analytics", layout="wide")
...
def main():
    ...
    if not df_sentiments.empty:
        ...
        text = alt.Chart(df_sentiments).mark_text(baseline="middle", fontSize=14, color="black").encode(
            x=alt.X("Attribut:N"),
            y=alt.Y("Produit:N"),
